...
public class RabbitMQConfigConst {
     ...
     * delayedDirect交换机名称
     */
    public static final String SIXIN_EXCHANGE = "sixin.exchange";

    /**
     * delayed direct队列名称
     */
    public static final String SIXIN_QUEUE = "sixin.queue";

    /**
     * delayed_direct路由Key
     */
    public static final String SIXIN_ROUTING = "sixin.routing";
